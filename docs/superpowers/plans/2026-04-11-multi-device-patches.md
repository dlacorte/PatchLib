...
```bash
DATABASE_URL="postgresql://patchlib_admin:fszIeiEZ6bR9OmYjA0aRTrkD@patchlib-aurora.cluster-cudka60y023m.us-east-1.rds.amazonaws.com:5432/patchlib" npx prisma migrate dev --name add_devices_and_knobsetting_device
```
...
```bash
DATABASE_URL="postgresql://patchlib_admin:fszIeiEZ6bR9OmYjA0aRTrkD@patchlib-aurora.cluster-cudka60y023m.us-east-1.rds.amazonaws.com:5432/patchlib" npx tsx scripts/migrate-to-multi-device.ts
```
...
```bash
DATABASE_URL="postgresql://patchlib_admin:fszIeiEZ6bR9OmYjA0aRTrkD@patchlib-aurora.cluster-cudka60y023m.us-east-1.rds.amazonaws.com:5432/patchlib" npx prisma migrate dev --name drop_patch_device_column
```
...
```bash
DATABASE_URL="postgresql://patchlib_admin:fszIeiEZ6bR9OmYjA0aRTrkD@patchlib-aurora.cluster-cudka60y023m.us-east-1.rds.amazonaws.com:5432/patchlib" npx tsx scripts/reseed.ts
```
